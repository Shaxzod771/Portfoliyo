...
-- Failed logins per IP, used to slow down password guessing
...
INSERT INTO `projects`
  (`title_uz`, `title_en`, `title_ru`, `desc_uz`, `desc_en`, `desc_ru`, `image`, `image_fit`, `github_url`, `live_url`, `layout`, `sort_order`, `is_published`, `created_at`, `updated_at`)
SELECT t_uz, t_en, t_ru, d_uz, d_en, d_ru, img, fit, gh, live, lay, ord, 1, NOW(), NOW() FROM (
  SELECT
